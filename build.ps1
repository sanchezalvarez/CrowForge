# CrowForge 0.3.0 — Final production build script (Windows)
# Run from the project root: .\build.ps1

$ErrorActionPreference = "Stop"

Write-Host ""
Write-Host "=== CrowForge v0.3.0 Build Started ===" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "=== CrowForge v0.3.0 Build Complete! ===" -ForegroundColor Cyan
