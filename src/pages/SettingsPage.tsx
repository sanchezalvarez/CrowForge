...
const GALLERY_MODELS: GalleryModel[] = [
  // ── Agent-capable models (tool calling / function calling) ──
  {
    ...
    size: "~5.8 GB",
    license: "Apache 2.0",
    description: "Best local agent model — Qwen3.5 with native tool calling, 262k context, 201 languages.",
    ...
    infoUrl: "https://huggingface.co/Qwen/Qwen3.5-9B",
    tags: ["agent", "coding", "reasoning", "multilingual"],
    vram: "7 GB",
    ram: "10 GB",
    recommended: true,
  },
  {
    ...
    size: "~16.5 GB",
    license: "Apache 2.0",
    description: "Large Qwen3.5 — exceptional reasoning, coding, and agent performance. 262k context.",
    ...
    infoUrl: "https://huggingface.co/Qwen/Qwen3.5-27B",
    tags: ["agent", "coding", "reasoning", "multilingual"],
    vram: "16 GB+",
    ram: "32 GB",
  },
  {
    ...
    size: "~2.7 GB",
    license: "Apache 2.0",
    description: "Lightweight Qwen3.5 with tool calling — great for low-end hardware.",
    filename: "Qwen_Qwen3.5-4B-Q4_K_M.gguf",
    url: "https://huggingface.co/bartowski/Qwen_Qwen3.5-4B-GGUF/resolve/main/Qwen_Qwen3.5-4B-Q4_K_M.gguf",
    infoUrl: "https://huggingface.co/Qwen/Qwen3.5-4B",
    tags: ["agent", "multilingual", "fast"],
    vram: "3 GB",
    ram: "6 GB",
  },
  {
    name: "Qwen3.5 35B-A3B MoE Q4_K_M",
    size: "~20.5 GB",
    license: "Apache 2.0",
    description: "MoE architecture — 35B total, 3B active params. Large-model quality at fast inference speed.",
    filename: "Qwen_Qwen3.5-35B-A3B-Q4_K_M.gguf",
    url: "https://huggingface.co/bartowski/Qwen_Qwen3.5-35B-A3B-GGUF/resolve/main/Qwen_Qwen3.5-35B-A3B-Q4_K_M.gguf",
    infoUrl: "https://huggingface.co/Qwen/Qwen3.5-35B-A3B",
    tags: ["agent", "reasoning", "coding", "moe"],
    vram: "6 GB",
    ram: "24 GB",
  },
  {
    ...
    size: "~19.5 GB",
    license: "Apache 2.0",
    description: "Google's flagship Gemma 4 — #3 on Arena AI, native function calling, 256k context, multimodal.",
    ...
    infoUrl: "https://huggingface.co/google/gemma-4-31B-it",
    tags: ["agent", "reasoning", "multilingual", "coding"],
    vram: "16 GB+",
    ram: "32 GB",
  },
  {
    name: "Gemma 4 26B-A4B MoE Instruct Q4_K_M",
    size: "~16.0 GB",
    license: "Apache 2.0",
    description: "Gemma 4 MoE — 26B total, 4B active params. Agent-class quality at efficient inference cost.",
    ...
    infoUrl: "https://huggingface.co/google/gemma-4-26B-A4B-it",
    tags: ["agent", "reasoning", "moe", "multilingual"],
    vram: "6 GB",
    ram: "20 GB",
  },
  {
    ...
    size: "~3.0 GB",
    license: "Apache 2.0",
    description: "Compact multimodal Gemma 4 with native tool calling — 4.5B effective parameters.",
    filename: "google_gemma-4-E4B-it-Q4_K_M.gguf",
    url: "https://huggingface.co/bartowski/google_gemma-4-E4B-it-GGUF/resolve/main/google_gemma-4-E4B-it-Q4_K_M.gguf",
    infoUrl: "https://huggingface.co/google/gemma-4-E4B-it",
    tags: ["agent", "multilingual", "fast"],
    vram: "4 GB",
    ram: "6 GB",
  },
  {
    name: "Llama 4 Scout 17B-16E MoE Q4_K_M",
    size: "~12.0 GB",
    license: "Llama 4",
    description: "Meta's Llama 4 Scout — 17B params, 16 experts MoE, 10M context window. Multimodal.",
    filename: "meta-llama_Llama-4-Scout-17B-16E-Instruct-Q4_K_M.gguf",
    url: "https://huggingface.co/bartowski/meta-llama_Llama-4-Scout-17B-16E-Instruct-GGUF/resolve/main/meta-llama_Llama-4-Scout-17B-16E-Instruct-Q4_K_M.gguf",
    infoUrl: "https://huggingface.co/meta-llama/Llama-4-Scout-17B-16E-Instruct",
    tags: ["agent", "chat", "reasoning", "moe"],
    vram: "12 GB",
    ram: "24 GB",
  },
  {
    ...
    size: "~14.3 GB",
    license: "Apache 2.0",
    description: "Mistral Small 3.1 — state-of-the-art 24B with native tool calling and 128k context.",
  ...
  {
    name: "Qwen3-Coder-Next 80B-A3B MoE Q4_K_M",
    size: "~48.0 GB",
    license: "Apache 2.0",
    description: "Agentic coder — 80B total, 3B active params. 70%+ SWE-Bench, 256k context. Designed for tool use.",
    filename: "Qwen_Qwen3-Coder-Next-Q4_K_M.gguf",
    url: "https://huggingface.co/bartowski/Qwen_Qwen3-Coder-Next-GGUF/resolve/main/Qwen_Qwen3-Coder-Next-Q4_K_M.gguf",
    infoUrl: "https://huggingface.co/Qwen/Qwen3-Coder-Next",
    tags: ["agent", "coding", "reasoning", "moe"],
    vram: "6 GB",
    ram: "64 GB",
  },
  {
    name: "Qwen3-Coder 30B-A3B MoE Q4_K_M",
    size: "~18.0 GB",
    license: "Apache 2.0",
    description: "Coding agent — 30B total, 3B active. Strong code generation and tool calling.",
    filename: "Qwen_Qwen3-Coder-30B-A3B-Instruct-Q4_K_M.gguf",
    url: "https://huggingface.co/bartowski/Qwen_Qwen3-Coder-30B-A3B-Instruct-GGUF/resolve/main/Qwen_Qwen3-Coder-30B-A3B-Instruct-Q4_K_M.gguf",
    infoUrl: "https://huggingface.co/Qwen/Qwen3-Coder-30B-A3B-Instruct",
    tags: ["agent", "coding", "moe"],
    vram: "6 GB",
    ram: "24 GB",
  },
  ...
  },
  {
    ...
    size: "~8.9 GB",
    license: "MIT",
    description: "Microsoft Phi-4 — punches well above its weight in reasoning and coding.",
  ...
  },
  {
    ...
    size: "~2.5 GB",
    license: "MIT",
    description: "Microsoft's efficient small model — strong coding and reasoning at minimal resource cost.",
    filename: "phi-4-mini-instruct-Q4_K_M.gguf",
    url: "https://huggingface.co/bartowski/phi-4-mini-instruct-GGUF/resolve/main/phi-4-mini-instruct-Q4_K_M.gguf",
    infoUrl: "https://huggingface.co/microsoft/phi-4-mini-instruct",
  ...
  },
  {
    ...
    size: "~1.5 GB",
    license: "Apache 2.0",
    description: "Tiny Gemma 4 — 2.3B effective parameters, fast and lightweight.",
    filename: "google_gemma-4-E2B-it-Q4_K_M.gguf",
    url: "https://huggingface.co/bartowski/google_gemma-4-E2B-it-GGUF/resolve/main/google_gemma-4-E2B-it-Q4_K_M.gguf",
    infoUrl: "https://huggingface.co/google/gemma-4-E2B-it",
  ...
  },
  {
    ...
    size: "~19.5 GB",
    license: "MIT",
    description: "DeepSeek-R1 reasoning distilled into Qwen 32B — strongest R1 distillation for chain-of-thought.",
    ...
    infoUrl: "https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Qwen-32B",
...
const ALL_TAGS = ["all", "agent", "chat", "translate", "multilingual", "coding", "reasoning", "math", "moe", "fast", "general"];
                  ...
                  <>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="gemini-2.0-flash">gemini-2.0-flash (budget)</option>
                      </select>
                    </div>
                  </>
                )}
